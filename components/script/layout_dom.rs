...
use dom::bindings::codegen::InheritTypes::{HTMLIFrameElementCast, HTMLCanvasElementCast};
use dom::bindings::codegen::InheritTypes::{HTMLImageElementCast, HTMLInputElementCast};
use dom::bindings::codegen::InheritTypes::{HTMLTextAreaElementCast, NodeCast, TextCast};
use dom::bindings::js::LayoutJS;
use dom::characterdata::{CharacterDataTypeId, LayoutCharacterDataHelpers};
use dom::element::{Element, ElementTypeId};
use dom::element::{LayoutElementHelpers, RawLayoutElementHelpers};
use dom::htmlelement::HTMLElementTypeId;
use dom::htmlcanvaselement::{HTMLCanvasElement, LayoutHTMLCanvasElementHelpers};
use dom::htmliframeelement::HTMLIFrameElement;
use dom::htmlimageelement::LayoutHTMLImageElementHelpers;
use dom::htmlinputelement::{HTMLInputElement, LayoutHTMLInputElementHelpers};
use dom::htmltextareaelement::{HTMLTextAreaElement, LayoutHTMLTextAreaElementHelpers};
use dom::node::{Node, NodeTypeId};
use dom::node::{LayoutNodeHelpers, RawLayoutNodeHelpers};
use dom::node::{HAS_CHANGED, IS_DIRTY, HAS_DIRTY_SIBLINGS, HAS_DIRTY_DESCENDANTS};
use dom::text::Text;
...
impl<'ln> TLayoutNode2 for LayoutNode<'ln> {
...
impl<'ln> LayoutNode<'ln> {
    ...
    pub fn children(self) -> LayoutNodeChildrenIterator<'ln> {
        ...
        fn first_child<T: TLayoutNode + TLayoutNode2>(this: T) -> Option<T> {
            this.first_child()
        }
...
#[derive(Copy, Clone)]
#[allow(unrooted_must_root)] // Only used while DOM is immutable
...
pub fn get_content(content_list: &content::T) -> Vec<ContentItem> {
    match *content_list {
...
impl<'ln> ThreadSafeLayoutNode<'ln> {
    ...
    pub unsafe fn next_sibling(&self) -> Option<ThreadSafeLayoutNode<'ln>> {
